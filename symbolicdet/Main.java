...
import static symbolicdet.matrix.PredefinedMatrices.getPredefinedTestMatrix4;
import static symbolicdet.matrix.PredefinedMatrices.getPredefinedTestMatrix5;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (n == 5) {
            ...
            matrix = getPredefinedTestMatrix5(varsUsed);
        } else if (n == 4) {
        ...
        while (askYesNo(sc, "Compute determinant of reduced matrix?")) {
            ...
            for (int i = 0; i < target.getN(); i++) System.out.print(i + " ");
            System.out.println();
    ...
    public static void setPersistentVars(Map<String, Double> persistentVars) {
        Main.persistentVars = persistentVars;
    }
    ...
    public static void setCurrentReduced(Matrix currentReduced) {
        Main.currentReduced = currentReduced;
    }
}